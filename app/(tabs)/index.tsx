...
import type { HomeData, Priority, Task } from "@/types/home";
    ...
    <View style={styles.taskRow}>
      ...
      <View style={styles.taskInfo}>
        ...
        <View style={styles.taskMeta}>
          ...
          >
            <Text
              style={[styles.subjectPillText, { color: task.subject.color }]}
            >
              {task.subject.name}
            </Text>
          </View>
        ...
        <>
          ...
          <ThemedView style={styles.section}>
            <View style={styles.sectionHeader}>
              <ThemedText type="subtitle" darkColor="#000" lightColor="#fff">
                Próximas entregas
              </ThemedText>
              <TouchableOpacity>
              ...
              <View key={m.subjectId} style={styles.subjectProgress}>
                <View style={styles.subjectProgressHeader}>
                  <View style={styles.subjectProgressLeft}>
                    <View
                      style={[styles.subjectDot, { backgroundColor: m.color }]}
                    />
                    <Text style={styles.subjectName}>{m.name}</Text>
                  </View>
                  <Text style={[styles.subjectPct, { color: m.color }]}>
                    {m.progressPct}%
                  </Text>
                </View>
